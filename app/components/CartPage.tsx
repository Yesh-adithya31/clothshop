...
const CartPage: React.FC<CartState> = ({ cartItems }) => {
  ...
  const handleCheckout = () => {
    const values: string[] = ["1", "2"]; // Replace with your actual values
    ...
    <div className="mx-auto w-full h-screen p-5 bg-white md:hidden ">
      ...
      <div className="bg-white p-4 fixed bottom-0 left-0 right-0">
        <div className="flex justify-center">
          <button className="bg-indigo-700 text-white font-bold px-7 py-2 rounded-lg" onClick={handleCheckout}>Checkout</button>
